...
- Passion project; the owner is new to app development. One shared codebase for both stores. Store name: Klondike Solitaire.
...
- `01` [How should the Klondike table look and play on a phone in portrait and landscape?](issues/01-klondike-table-look-and-play.md) (`prototype`, was #6)
- `02` [What are the v1 rules for Undo, resume, tap, and drag?](issues/02-undo-resume-tap-drag.md) (`grilling`, was #7)
- `03` [What copy goes on the App Store and Play listings?](issues/03-store-listing-copy.md) (`grilling`, was #10)
- `04` [What icon, feature graphic, and screenshots does v1 use?](issues/04-listing-visuals.md) (`prototype`, was #11) — blocked by 01
- `05` [Does Play list Klondike Solitaire as including children?](issues/05-play-target-audience-children.md) (`grilling`, was #12)
- `06` [Can we build and install the Klondike table prototype on Android locally?](issues/06-android-local-prototype-build.md) (`task`, was #13)
- `07` [Can we build and install the Klondike table prototype on iOS locally?](issues/07-ios-local-prototype-build.md) (`task`, was #14)
...
- [Which one-codebase toolkit should a beginner use to ship Klondike Solitaire?](https://github.com/jusanherndon/Solitare/issues/2) — Expo (React Native): one JS/TS codebase, local Game, both stores, no Mac required for iOS builds.
